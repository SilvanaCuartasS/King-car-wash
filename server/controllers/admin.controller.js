...
const { getAllAdmins } = require("../db/admins.db.js");
...
const loginAdmin = async (req, res) => {
  ...
  const aver = { inputEmail, inputPassword, inputAdminCode } = req.body;
  ...
  const foundAdmin = admins.find(
    (u) => u.email === inputEmail && u.password === inputPassword && u.adminCode === inputAdminCode
  );
  ...
  res.send(admins); //Envio al cliente lo que tenga admins
};
